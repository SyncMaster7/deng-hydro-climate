...
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS ref.hydrometric_stations (
    id                      BIGSERIAL PRIMARY KEY,
...
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS ref.meteorological_stations (
    id               BIGSERIAL PRIMARY KEY,
...
-- Auto-generated by seed DAG using haversine formula (not loaded from CSV)
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS ref.station_proximity (
    id                  BIGSERIAL PRIMARY KEY,
